<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="admin/category/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i> Category<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/category/danhsach">Danh Sách</a>
                    </li>
                    <li>
                        <a href="admin/category/them">Thêm</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="#"><i class="fa fa-cube fa-fw"></i>Size<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/size/danhsach">Danh sách</a>
                    </li>
                    <li>
                        <a href="admin/size/them">Thêm size</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/color/danhsach">Danh sách</a>
                    </li>
                    <li>
                        <a href="admin/color/them">Thêm color</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
